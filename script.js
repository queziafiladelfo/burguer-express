    ...
    cart.forEach(item => {
        ...
        cartItemElement.innerHTML = `
            <div class="flex items-center justify-between pr-1">
                ...
                <buttom class="remove-from-cart-btn font-semibold text-red-800 hover:scale-110 duration-200 cursor-pointer"
                    data-name="${item.name}"
                >
                    Remover
                </buttom>
...
addressInput.addEventListener("input", function (event) {
    ...
    if (addressInput.value !== "") {
        addressInput.classList.remove("border-red-800");
...
checkoutBtn.addEventListener("click", function () {
    ...
    if (addressInput.value === "") {
        ...
        addressInput.classList.add("border-red-800");
        return;
    }
